from codelets.examples.genesys.genesys_instructions import DTYPE_CAST_NAMES, \
    CMP_OP_NAMES, CALC_OP_NAMES, ALU_OP_NAMES

from .loops import loop_template, loop_end_template

from .sa_buffers import ibuf_start_template, bbuf_start_template, \
    obuf_start_template, wbuf_start_template
from .sa_compute import sa_mvmul_template
from .sa_transfers import off_chip_transfer
from .simd_compute import simd_alu_template
from .simd_memory import imm_start_template, imm_end_template
from .simd_transfers import off_chip_transfer_simd
from .start_end import codelet_start, program_end, program_start, codelet_end, \
