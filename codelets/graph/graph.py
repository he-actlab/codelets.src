...
class Graph(object):
    ...
    def _add_edge(self, src_node, dst_node):
        ...
        # check if src and dests are both in the graph
        ...
        # NOTE add_succ and add_pred deals with both src and dests nodes.
    ...
    def remove_edge(self, src_node, dst_node):
        ...
        # NOTE remove_succ and remove_pred deals with both src and dests nodes.
        # therefore, only one invocation is required
