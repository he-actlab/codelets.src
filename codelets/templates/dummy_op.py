...
class DummyOp:
    ...
    def evaluate(self, instance_args):
        ...
        return self.flex_param.evaluate_fn(*obj_instances)

    def __mul__(self, other):
        return dummy_mul(other, self)

    def __rmul__(self, other):
        return dummy_rmul(other, self)

    def __add__(self, other):
        return dummy_add(other, self)

    def __radd__(self, other):
        return dummy_radd(other, self)

    def __sub__(self, other):
        return dummy_sub(other, self)

    def __rsub__(self, other):
        return dummy_rsub(other, self)

    def __truediv__(self, other):
        return dummy_div(other, self)

    def __rdiv__(self, other):
        return dummy_rdiv(other, self)

    def __floordiv__(self, other):
        return dummy_floor_div(other, self)

    def __rfloordiv__(self, other):
        return dummy_rfloor_div(other, self)
...
class DummyParam:
    ...
    def evaluate(self, instance_args):
        ...
        for d in self.dummy_args:
            ...
            args.append(res)
        return self.flex_param.evaluate_fn(*tuple(args))
