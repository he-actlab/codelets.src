...
if ASIC_CONFIG:
    ...
    GENESYS_CFG['IBUF_DEPTH'] = int(1048576 / (GENESYS_CFG['ARRAY_M']*GENESYS_CFG['DATA_WIDTH'])) // DIV_FACTOR
    GENESYS_CFG['WBUF_DEPTH'] = int(2097152 / (GENESYS_CFG['ARRAY_M']*GENESYS_CFG['ARRAY_N']*GENESYS_CFG['ACC_WIDTH'])) // DIV_FACTOR
    GENESYS_CFG['OBUF_DEPTH'] = int(2097152*2 / (GENESYS_CFG['ARRAY_N']*GENESYS_CFG['ACC_WIDTH'])) // DIV_FACTOR
    GENESYS_CFG['BBUF_DEPTH'] = int(32768 / (GENESYS_CFG['ARRAY_M']*GENESYS_CFG['ACC_WIDTH'])) // DIV_FACTOR
