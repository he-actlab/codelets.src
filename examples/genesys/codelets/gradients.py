...
def sgd1d(hag: ArchitectureNode):
    ...
    with CodeletTemplate("sgd1d") as cdlt:
        ...
        param = cdlt.create_operand_template("param", OP_DTYPES, [N], default_dtype=acc_dtype)
        grad = cdlt.create_operand_template("grad", OP_DTYPES, [N], default_dtype=acc_dtype)
        updated_param = cdlt.create_operand_template("updated", OP_DTYPES, [N], default_dtype=acc_dtype)
        ...
        itemp1 = cdlt.create_operand_template("itemp1", OP_DTYPES, [N], default_dtype=acc_dtype)
        itemp2 = cdlt.create_operand_template("itemp2", OP_DTYPES, [N], default_dtype=acc_dtype)
