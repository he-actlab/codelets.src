...
def inner_sa_loops(hag: ArchitectureNode):
    ...
    # systolic_operands = f"cdlt.operands"
    ...
    instr.set_field_flex_param("STRIDE",
                               f"program.extract_bits({systolic_compute}.dests[0].get_offset(cdlt, 2, op.loop_id, hag, outer_loop=False, movement_type='down'), 16, 0)")
    instructions.append(instr)
    ...
    instr.set_field_flex_param("STRIDE",
                               f"program.extract_bits({systolic_compute}.dests[0].get_offset(cdlt, 2, op.loop_id, hag, outer_loop=False, movement_type='down'), 16, 16)")
    instructions.append(instr)
    return instructions
...
def outer_sa_loops(hag: ArchitectureNode):
    ...
    macro_instr = hag.get_primitive_template("SET_LOOP_STRIDE")
    macro_instr.add_iterable('operand', operand_iter)
    ...
    micro_instr = hag.get_primitive_template("SET_LOOP_STRIDE")
    micro_instr.add_iterable('operand', operand_iter)
    ...
    # macro_instr = hag.get_primitive_template("SET_LOOP_STRIDE")
    # macro_instr.add_iterable('operand', f'cdlt.temps')
    # macro_instr.add_condition(f"{pe_target_cond} and {temp_operand_storage_cond}")
    # macro_instr.set_field_by_name("LOW_HIGH_BITS", "LOW")
    # macro_instr.set_field_by_name("ACCESS_TYPE", "LD")
    # macro_instr.set_field_flex_param("LOOP_ID", "op.loop_id")
    # macro_instr.set_field_flex_param("BUFFER", f"operand.get_ld_storage_location(cdlt, 1, return_null=True)")
    # macro_instr.set_field_flex_param("STRIDE",
    #                                  f"program.extract_bits({stride_str}, 16, 0)")
    #
    # micro_instr = hag.get_primitive_template("SET_LOOP_STRIDE")
    # micro_instr.add_iterable('operand', f'cdlt.temps')
    # micro_instr.add_condition(f"{pe_target_cond} and {temp_operand_storage_cond}")
    # micro_instr.set_field_by_name("LOW_HIGH_BITS", "HIGH")
    # micro_instr.set_field_by_name("ACCESS_TYPE", "LD")
    # micro_instr.set_field_flex_param("LOOP_ID", "op.loop_id")
    # micro_instr.set_field_flex_param("BUFFER", f"operand.get_ld_storage_location(cdlt, 1, return_null=True)")
    # micro_instr.set_field_flex_param("STRIDE",
    #                                  f"program.extract_bits({stride_str}, 16, 16)")
    # macro_instr.add_base_instruction(micro_instr)
    # instructions.append(macro_instr)
